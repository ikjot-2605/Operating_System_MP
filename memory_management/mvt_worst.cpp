...
bool worst_delete_partition (int n) {
    for (int i=0; i<partitions.size(); i++) {
    ...
    while (true) {
        ...
        switch (choice) {
            case 1: // make a new allocation request
                ...
                allocated_partition = worst_allocate_partition(temp);
            ...
            case 2: // unallocate an existing process
                ...
                cin >> n;
                if (worst_delete_partition(n)) cout << "The process was unallocated." << endl;
